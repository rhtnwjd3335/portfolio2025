$(document).ready(function () {
    ...
    $('nav ul li:nth-child(1)').click(function () {
        ...
        if (cnum1 == 1) {
            ...
            if (window.innerWidth <= 700) {
                $('h1').css({ 'justify-content': 'center', 'padding-left': '50px', 'box-sizing': 'border-box', 'padding-top': '50px' });
                $('h1 img').css({ 'width': '80%', 'height': '40%', 'margin-top': '-35px', 'margin-left': '-50px' });
                $('nav').css({ 'margin-top': '50px' });
                $('nav ul li').css({ 'top': '-280px' });
                $('nav ul li:nth-child(1)').css({ 'background-image': 'url(img/title_bg_01.png)', 'color': '#45B472', 'top': '-280px' });
            ...
            if (window.innerWidth <= 700) {
                ...
                $('h1 img').css({ 'width': '400px', 'height': '280px', 'margin-left': '-65px', 'margin-top': '0px' });
                $('nav').css({ 'margin-top': '-50px' });
                $('nav ul li').css({ 'top': '-280px' });
                $('nav ul li:nth-child(2)').css({ 'top': '130px' });
                $('nav ul li:nth-child(3)').css({ 'top': '230px' });
                $('nav ul li:nth-child(4)').css({ 'top': '330px' });
                $('nav ul li:nth-child(1)').css({ 'background-image': 'url(img/title_bg_02.png)', 'color': '#fff', 'top': '20px' });
                ...
                $('h1').css({ 'justify-content': 'center', 'padding-right': '0', 'padding-top': '50px' });
                $('h1 img').css({ 'width': '900px', 'height': '420px', 'margin-top': '100px' });
    ...
    $('nav ul li:nth-child(2)').click(function () {
        ...
        if (cnum2 == 1) {
            ...
            if (window.innerWidth <= 700) {
                ...
                $('nav').css({ 'margin-top': '50px' });
                $('nav ul li').css({ 'top': '-280px' });
                $('nav ul li:nth-child(2)').css({ 'background-image': 'url(img/title_bg_01.png)', 'color': '#45B472', 'top': '-280px' });
                $('nav div').css({ 'top': '-240px' });
            ...
            if (window.innerWidth <= 700) {
                ...
                $('nav').css({ 'margin-top': '-50px' });
                $('nav ul li').css({ 'top': '-280px' });
                $('nav ul li:nth-child(1)').css({ 'top': '20px' });
                $('nav ul li:nth-child(3)').css({ 'top': '230px' });
                $('nav ul li:nth-child(4)').css({ 'top': '330px' });
                $('nav ul li:nth-child(2)').css({ 'background-image': 'url(img/title_bg_02.png)', 'color': '#fff', 'top': '130px' });
    ...
    $('nav ul li:nth-child(3)').click(function () {
        ...
        if (cnum3 == 1) {
            ...
            if (window.innerWidth <= 700) {
                ...
                $('nav').css({ 'margin-top': '50px' });
                $('nav ul li').css({ 'top': '-280px' });
                $('nav ul li:nth-child(3)').css({ 'background-image': 'url(img/title_bg_01.png)', 'color': '#45B472', 'top': '-280px' });
                $('nav div').css({ 'top': '-240px' });
            ...
            if (window.innerWidth <= 700) {
                ...
                $('nav ul li:nth-child(2)').css({ 'top': '130px' });
                $('nav ul li:nth-child(4)').css({ 'top': '330px' });
                $('nav ul li:nth-child(3)').css({ 'background-image': 'url(img/title_bg_02.png)', 'color': '#fff', 'top': '230px' });
                $('nav .box1').css({ 'top': '58px' });
                $('nav .box2').css({ 'top': '168px' });
                $('nav .box4').css({ 'top': '368px' });
    ...
    $('nav ul li:nth-child(4)').click(function () {
        ...
        if (cnum4 == 1) {
            ...
            if (window.innerWidth <= 700) {
                ...
                $('nav').css({ 'margin-top': '50px' });
                $('nav ul li').css({ 'top': '-280px' });
                $('nav ul li:nth-child(4)').css({ 'background-image': 'url(img/title_bg_01.png)', 'color': '#45B472', 'top': '-280px' });
                $('nav div').css({ 'top': '-240px' });
            ...
            if (window.innerWidth <= 700) {
                ...
                $('nav ul li:nth-child(2)').css({ 'top': '130px' });
                $('nav ul li:nth-child(3)').css({ 'top': '230px' });
                $('nav ul li:nth-child(4)').css({ 'background-image': 'url(img/title_bg_02.png)', 'color': '#fff', 'top': '330px' });
                $('nav .box2').css({ 'top': '168px' });
                $('nav .box3').css({ 'top': '268px' });
                $('nav .box1').css({ 'top': '58px' });
    ...
    for (let ps = 0; ps < 4; ps++) {
        $(`.project0${ps} .btn li:nth-child(1)`).click(function () {
